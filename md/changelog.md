...
#### Updated
  ...
  * **Every Compat**: Ultimate Wood Compat Mod **(1.20-2.7.10 to 1.20-2.7.21)**
  ...
  * **What Are They Up To**: Lets you see if players are typing, in a GUI, idle, with cool ingame visuals **(1.20.1-1.1.3 to 1.20.1-1.2.1)**
  ...
  * **Smooth chunk save Mod**: Spreads out chunk saves equally and saves them after a configured delay **(1.20.1-3.8 to 1.20.1-4.1)**
  ...
  * **Jade**: Minecraft mod shows what you are looking at. (Hwyla fork) **(11.12.0+fabric to 11.13.1+fabric)**
  ...
  * **Distant Horizons**: This mod generates and renders simplified terrain beyond the normal view distance at a low performance cost. Allowing you to see much farther without turning your game into a slideshow. **(2.2.1-a to 2.3.0-b)**
...
#### Added
  ...
  * **FTB Library**: Foundational library for FTB mods.
...
#### Updated
  * **End's Delight**: An addon mod for Farmer's Delight based around adding culinary content to the end! **(2.1 to refabricated-1.20.1-2.5)**
  * **Immersive Aircraft**: A bunch of rustic aircraft to travel, transport, and explore!.  **(1.0.1+1.20.1 to 1.1.8+1.20.1)**
  * **Pufferfish's Attributes**: Adds more attributes to the game. **(0.5.0 to 0.7.1)**
  * **Every Compat**: Ultimate Wood Compat Mod **(1.20-2.6.73 to 1.20-2.7.10)**
  * **Pufferfish's Skills**: Adds a fully configurable skill system to the game. **(0.12.2 to 0.14.5)**
  * **Neruina**: This is a mod that prevents ticking entity and ticking block entity / tile entity crashes from bricking worlds. **(2.1.2 to 2.2.7)**
  * **ModernFix**: Egregious, yet effective performance improvements for modern Minecraft **(5.19.4+mc1.20.1 to 5.20.0+mc1.20.1)**
  * **GeckoLib 4**: GeckoLib is an animation engine for Minecraft Mods, with support for complex 3D keyframe-based animations, 30+ easings, concurrent animation support, sound and particle keyframes, event keyframes, and more. **(4.4.9 to 4.7)**
  * **Farmer's Delight**: A cozy expansion to farming and cooking! **(1.20.1-2.1.4+refabricated to 1.20.1-2.2.5+refabricated)**
  * **Amendments**: Many tweaks to Vanilla Blocks **(1.20-1.2.8 to 1.20-1.2.14)**
  * **Create**: Technology that empowers the player. **(0.5.1-f-build.1417+mc1.20.1 to 0.5.1-j-build.1631+mc1.20.1)**
  * **Moonlight**: Custom Villagers AI and Map Markers, First and third person item animations, dynamic assets and registration & more **(1.20-2.12.17 to 1.20-2.13.46)**
  * **Cardinal Components API**: Attaching more data to various game objects **(5.2.2 to 5.2.3)**
  ...
  * **Fright's Delight**: Fright's Delight is an add-on mod for Farmer's Delight Fabric that adds food made from mob drops. Dishes are created with a 'Horror' theme, consume with caution. **(1.1.0 to 1.2.2)**
  * **Geophilic**: A subtle-ish overhaul of vanilla Overworld biomes. **(3.1.1 to 3.1.5)**
  * **Iceberg**: A library containing events, helpers, and utilities to make modding easier. **(1.1.18 to 1.1.25)**
  * **Illager Invasion**: The illagers are back! Be ready to fight new foes. A port of Illager Expansion. **(8.0.5 to 8.0.6)**
  * **ImmediatelyFast**: Speed up and optimize immediate mode rendering in Minecraft **(1.2.21+1.20.4 to 1.3.3+1.20.4)**
  ...
  * **Iris**: A modern shaders mod for Minecraft intended to be compatible with existing OptiFine shader packs **(1.7.2+mc1.20.1 to 1.7.5+mc1.20.1)**
  * **Iris Flywheel Compat**: Allow Flywheel instancing optimization to be enabled when using iris. **(1.1.3a to 1.1.4)**
  * **Jade**: Minecraft mod shows what you are looking at. (Hwyla fork) **(11.11.0+fabric to 11.12.0+fabric)**
  * **Jade Addons**: Jade's additional mod supports for Fabric. **(5.3.1+fabric to 5.4.0+fabric)**
  * **Kiwi Library**: Minecraft modding library **(11.8.24+fabric to 11.8.28+fabric)**
  * **[Let's Do] Vinery**: In Vino Veritas - it's time for wine! Build your own vineyard, produce wine, and establish your own winery. **(1.4.28 to 1.4.34)**
  * **Lootr**: A mod that makes it so nobody misses out on Loot! **(0.7.34.84 to 0.7.35.85)**
  * **Macaw's Trapdoors**: Adds vanila trapdoors in every plank variation, and some new trapdoors too! **(1.1.3 to 1.1.4)**
  * **Polymorph**: No more recipe conflicts! Adds an option to choose the crafting result if more than one is available. **(0.49.5+1.20.1 to 0.49.8+1.20.1)**
  * **Presence Footsteps**: An overly complicated sound mod. **(1.9.4+1.20.1 to 1.10.1+1.20.1)**
  * **Puzzles Lib**: Why's it called Puzzles you ask? That's the puzzle! **(8.1.22 to 8.1.25)**
  * **Quilted Fabric API**: A reimplementation of Fabric API on top of Quilt Standard Libraries. **(7.6.0+0.92.2-1.20.1 to 7.7.0+0.92.2-1.20.1)**
  * **Respite Creators**: Making automation between Farmer's Respite and Create **(1.3.0 to 1.3.0-FDR)**
  * **Roughly Enough Items**: Clean and Customizable. **(12.1.750 to 12.1.785)**
  ...
  * **Smooth chunk save Mod**: Spreads out chunk saves equally and saves them after a configured delay **(1.20.1-3.6 to 1.20.1-3.8)**
  * **Sound Physics Remastered**: Provides realistic sound attenuation, reverberation, and absorption through blocks. **(1.20.1-1.4.5 to 1.20.1-1.4.8)**
  * **Spell Engine**: Data driven magic library. **(0.15.10+1.20.1 to 0.15.12+1.20.1)**
  * **Supplementaries**: Many functional and useful Vanilla+ blocks **(1.20-2.8.17 to 1.20-3.1.11)**
  * **YetAnotherConfigLib**: YetAnotherConfigLib (yacl) is just that. A builder-based configuration library for Minecraft. **(3.5.0+1.20.1-fabric to 3.6.2+1.20.1-fabric)**
  ...
  * **AzureLib Armor**: A striped down Azurelib just for Armor! **(2.0.6 to 2.0.14)**
  * **Balm**: Abstraction Layer (but not really)TM for Blay's multiplatform mods **(7.3.9 to 7.3.10)**
  ...
  * **BotanyPots**: Pots for growing different types of plants. **(13.0.38 to 13.0.40)**
  * **BotanyTrees**: Allows Botany Pots to grow trees. **(9.0.15 to 9.0.18)**
  * **Bountiful**: Bountiful adds bounty boards to the world. **(6.0.3+1.20.1 to 6.0.4+1.20.1)**
  * **Chat Heads**: See who are you chatting with!. This mod adds player heads next to their chat messages. **(0.12.13 to 0.13.7)**
  * **Cloth Config v11**: An API for config screens. **(11.1.118 to 11.1.136)**
  * **Collective**: Collective is a shared library with common code for all of Serilum's mods. **(7.84 to 7.87)**
  * **Crate Delight**: A mod that adds crates and bags to the game. **(24.08.09-1.20-fabric to 24.11.22-1.20-fabric)**
  * **Deeper and Darker**: A Minecraft mod which features more blocks, items, armors, and hidden mysteries to complement the Deep Dark biome. **(1.3.1 to 1.3.3)**
  * **Delightful Creators**: Making automation between Farmer's Delight and Create **(1.3-1.20.x to 1.3-1.20.x-FDR-support)**
  * **Distant Horizons**: This mod generates and renders simplified terrain beyond the normal view distance at a low performance cost. Allowing you to see much farther without turning your game into a slideshow. **(2.1.2-a to 2.2.1-a)**
#### Removed
...
#### Updated
  ...
  * **Amendments**: Many tweaks to Vanilla Blocks **(1.20-1.2.4 to 1.20-1.2.8)**
  * **Archers (RPG Series)**: Draw, Release, Conquer - Master the art of Archery! **(1.2.1+1.20.1 to 1.2.4+1.20.1)**
  * **AzureLib Armor**: A striped down Azurelib just for Armor! **(2.0.3 to 2.0.5)**
  * **Balm**: Abstraction Layer (but not really)TM for Blay's multiplatform mods **(7.3.4 to 7.3.6)**
  * **BotanyPots**: Pots for growing different types of plants. **(13.0.33 to 13.0.35)**
  * **Chat Heads**: See who are you chatting with!. This mod adds player heads next to their chat messages. **(0.12.3 to 0.12.6)**
  * **Collective**: Collective is a shared library with common code for all of Serilum's mods. **(7.61 to 7.70)**
  * **Crate Delight**: An addon mod for Farmer's Delight that adds more crates and bags to the base mod. **(2024.05.05-1.20-fabric to 2024.06.21-1.20-fabric)**
  * **cupboard**:  **(1.20.1-2.6 to 1.20.1-2.7)**
  * **Distant Horizons**: This mod generates and renders simplified terrain beyond the normal view distance at a low performance cost. Allowing you to see much farther without turning your game into a slideshow. **(2.1.0-a to 2.1.2-a)**
  * **End's Delight**: An addon mod for Farmer's Delight based around adding culinary content to the end! **(refabricated-1.20.1-alpha-1.0 to 2.0)**
  * **Every Compat**: Ultimate Wood Compat Mod **(1.20-2.6.61 to 1.20-2.6.65)**
  * **Explorify**: A simplistic, vanilla-friendly collection of new structures. **(v1.4.0 to 1.6.1)**
  * **Fast IP Ping**: Yeet the laggy reversed DNS lookup for pure IP server addresses **(1.0.1 to 1.0.3)**
  * **Create: Storage**: A Storage System for Create by FoxyNoTail **(0.8-1.20.1-FABRIC+1.20.1 to 0.12-1.20.1-FABRIC+1.20.1)**
  * **GeckoLib 4**: GeckoLib is an animation engine for Minecraft Mods, with support for complex 3D keyframe-based animations, 30+ easings, concurrent animation support, sound and particle keyframes, event keyframes, and more. **(4.4.4 to 4.4.7)**
  * **Geophilic**: A subtle overhaul of vanilla Overworld biomes. **(v2.4.0 to 2.4.2)**
  * **Inventory HUD +**: This mod will show you your inventory while playing. Enjoy! **(3.4.18 to 3.4.22)**
  * **Iris**: A modern shaders mod for Minecraft intended to be compatible with existing OptiFine shader packs **(1.7.1+mc1.20.1 to 1.7.2+mc1.20.1)**
  * **[Let's Do] API**: This is an API for the Let's do mods **(1.2.13 to 1.2.15)**
  * **[Let's Do] Vinery**: In Vino Veritas - it's time for wine! Build your own vineyard, produce wine, and establish your own winery. **(1.4.22 to 1.4.25)**
  * **Macaw's Doors**: Adds a lot of new Doors! With vanila and unique styles. **(1.1.0 to 1.1.1)**
  * **Macaw's Fences and Walls**: Adds new vanila styled fences, walls and gates! **(1.1.1 to 1.1.2)**
  * **Macaw's Lights and Lamps**: Adds vanila styled lights, lamps, torches, street lamp posts... Make your worlds brighter! **(1.0.6 to 1.1.1)**
  * **Moonlight**: Custom Villagers AI and Map Markers, First and third person item animations, dynamic assets and registration & more **(1.20-2.11.37 to 1.20-2.12.6)**
  * **Neruina**: This is a mod that prevents ticking entity and ticking block entity / tile entity crashes from bricking worlds. **(2.0.0-beta.10 to 2.1.0)**
  * **Paladins & Priests (RPG Series)**: Protect and heal your friends as a Paladin or a Priest. **(1.2.0+1.20.1 to 1.2.6+1.20.1)**
  * **Pufferfish's Attributes**: Adds more attributes to the game. **(0.3.0 to 0.4.0)**
  * **Puzzles Lib**: Why's it called Puzzles you ask? That's the puzzle! **(8.1.20 to 8.1.21)**
  * **RangedWeaponAPI**: Allows creating bows and crossbows, with just a few line of code **(1.1.1+1.20.1 to 1.1.2+1.20.1)**
  * **Runes**: Craft runes to serve as ammo for spells. **(0.9.11+1.20.1 to 0.9.13+1.20.1)**
  * **SimplySkills**: A comprehensive skill tree mod with a focus on combat specialisations. **(1.4.1+1.20.1 to 1.5.0+1.20.1)**
  * **Sodium**: Sodium is a free and open-source optimization mod for Minecraft which improves frame rates and reduces lag spikes. **(0.5.10+mc1.20.1 to 0.5.11+mc1.20.1)**
  * **Spell Engine**: Data driven magic library. **(0.14.3+1.20.1 to 0.15.6+1.20.1)**
  * **Spell Power Attribute**: Spell Power entity attributes with related status effects and enchantments. **(0.10.2+1.20.1 to 0.11.0+1.20.1)**
  * **Supplementaries**: Many functional and useful Vanilla+ blocks **(1.20-2.8.15 to 1.20-2.8.17)**
  * **Thaumon**: Thaumcraft-inspired decoration blocks for modern Minecraft **(2.2.0+1.20.1 to 2.3.0+1.20.1)**
## v6.2.0
### Technicals
...
#### Updated
  ...
  * **Create**: Technology that empowers the player. **(0.5.1-d-build.1161+mc1.20.1 to 0.5.1-f-build.1417+mc1.20.1)**
  ...
  * **[Let's Do] API**: This is an API for the Let's do mods **(1.2.8 to 1.2.13)**
  * **[Let's Do] Vinery**: In Vino Veritas - it's time for wine! Build your own vineyard, produce wine, and establish your own winery. **(1.4.10 to 1.4.22)**
  * **Lootr**: A mod that makes it so nobody misses out on Loot! **(0.7.30.77 to 0.7.33.81)**
  * **Macaw's Bridges**: A simple mod that adds a lot of bridges! **(2.1.0 to 3.0.0)**
...
* Tuned shaders for more performance
### Mods
#### Added
  ...
  * **GeckoLibIrisCompat**: Fixes GeckoLib animations not playing while using shaderpacks that add entity shadows
#### Updated
  ...
  * **Every Compat**: Ultimate Wood Compat Mod **(1.20-2.6.18 to 1.20-2.6.26)**
  ...
  * **Macaw's Fences and Walls**: Adds new vanila styled fences, walls and gates! **(1.0.7 to 1.1.0)**
  * **Macaw's Furniture**: Chairs, Wardrobes, Drawers, Tables, Desks and more..! **(3.2.1 to 3.2.2)**
  * **Moonlight**: Custom Villagers AI and Map Markers, First and third person item animations, dynamic assets and registration & more **(1.20-2.8.70 to 1.20-2.8.84)**
  * **Puzzles Lib**: Why's it called Puzzles you ask? That's the puzzle! **(8.1.11 to 8.1.13)**
  * **Resourcefulconfig**:  **(2.1.0 to 2.1.2)**
  * **Supplementaries**: Many functional and useful Vanilla+ blocks **(1.20-2.7.14 to 1.20-2.7.27)**
